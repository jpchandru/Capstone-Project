...
@Entity(tableName = "favoriteatfnewsitemfull" , indices = {@Index(value = {"url"},
        unique = true)})
public class FavAtfNewsItemFull implements Parcelable {

    private static final String TAG = "FavAtfNewsItemFull";
    ...
    public  FavAtfNewsItemFull(){

    }

    public FavAtfNewsItemFull(@NonNull String emailId, String sourceName, String author, String title, String description, @NonNull String url, String imgUrl, String publishDate, String content, String newsType, String country, String category) {
    ...
    public boolean equals(Object o) {
        ...
        FavAtfNewsItemFull that = (FavAtfNewsItemFull) o;
    ...
    protected FavAtfNewsItemFull(Parcel in) {
    ...
    public static final Creator<FavAtfNewsItemFull> CREATOR = new Creator<FavAtfNewsItemFull>() {
        @Override
        public FavAtfNewsItemFull createFromParcel(Parcel source) {
            return new FavAtfNewsItemFull(source);
        }

        @Override
        public FavAtfNewsItemFull[] newArray(int size) {
            return new FavAtfNewsItemFull[size];
        }
    };
}
