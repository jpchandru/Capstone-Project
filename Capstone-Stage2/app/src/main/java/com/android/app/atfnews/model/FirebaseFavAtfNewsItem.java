...
public class FirebaseFavAtfNewsItem implements Parcelable {

    private static final String TAG = "FirebaseFavAtfNewsItem";
    ...
    public FirebaseFavAtfNewsItem(){

    }

    public FirebaseFavAtfNewsItem(@NonNull String emailId, String sourceName, String author, String title, String description, @NonNull String url, String imgUrl, String publishDate, String content, String newsType, String country, String category) {
    ...
    public boolean equals(Object o) {
        ...
        FirebaseFavAtfNewsItem that = (FirebaseFavAtfNewsItem) o;
    ...
    protected FirebaseFavAtfNewsItem(Parcel in) {
    ...
    public static final Creator<FirebaseFavAtfNewsItem> CREATOR = new Creator<FirebaseFavAtfNewsItem>() {
        @Override
        public FirebaseFavAtfNewsItem createFromParcel(Parcel source) {
            return new FirebaseFavAtfNewsItem(source);
        }

        @Override
        public FirebaseFavAtfNewsItem[] newArray(int size) {
            return new FirebaseFavAtfNewsItem[size];
        }
    };
}
